...
function buildMatrix() {
  ...
  let matrixCell = document.querySelectorAll('.matrixCell');
  let count = 0;

  matrixCell.forEach(elem => {
    elem.innerHTML = matrix[count];
    count++;
  })
}
...
function encrypt() {
  ...
  if ( plainT == "" ) {
    alert("Будь ласка, введіть текст, що повинен бути зашифрованний.");
  }
  else {
